...
| App | Description |
|-----|-------------|
| [Clawdbot](./geoffwellman-gw-clawdbot) | Personal AI assistant with WhatsApp, Telegram, Discord support |
...
~/umbrel/scripts/app update gw-clawdbot
```
...
1. Edit `gw-clawdbot/umbrel-app.yml`
